...
class TestPDF:
    ...
    @pytest.fixture
    def sample_pdf(self):
        return pdfr.PDFReader(r"tests\testdata\test_fas_pdf\samplePDF1.pdf")
    
    @pytest.fixture
    def sample_pdf2(self):
        return pdfr.PDFReader(r"tests\testdata\test_fas_pdf\samplePDF2.pdf")
    ...
    def test_invalid_file_type(self):
        with pytest.raises(Exception):
            pdfr.PDFReader(r"tests\testdata\test_fas_pdf\sampleText1.txt")

    def test_filepath(self, sample_pdf):
        assert sample_pdf.filepath == r"tests\testdata\test_fas_pdf\samplePDF1.pdf"
